...
<body>
    ...
    <nav>
        <ul>
            ...
            <li class="hideOnMobile" id="signupbutton"><a class="active-link" href="./views/signup.php">Sign Up</a></li>
        ...
        <ul class="sidebar">
            ...
            <li id="signupbutton"><a class="active-link" href="./views/signup.php">Sign Up</a></li>
    ...
    <div class="container.fluid">
        <div class="loginbackground">
            <form class="mx-auto" id="loginModal" method="POST">
                ...
                <p>go to <a href="./index2.php">Home</a></p>
            </form>
        </div>
    </div>
    <!--pop login script -->
    ...
    <section id="sectionId">
        <div class="container mt-5 inside-section" style="background-color:#fffbe9">
            <h4 class="text-center mt-2">Sign Up And Login to Register in the Events</h4>
            <div class="row">
                <?php
                ...
                while ($row = mysqli_fetch_assoc($res2)) {
                    ...
                    <div class="col-md-3 mt-3 column">
                        <div class="card mt-5" style="width: 100%; height:auto;">
                            ...
                            ?>
                            <img class="admin-img" src="<?php echo $row['image']; ?>" width="100%" alt="image"></a>
